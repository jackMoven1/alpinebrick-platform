...
describe('walmart channel schema', () => {
  ...
  it('enforces ChannelEvent idempotency key and creates channel tables', async () => {
    ...
    await prisma.channelSettlement.create({ data: { reportDate: new Date(), externalOrderId: 'PO-1', transactionType: 'PaymentWithdrawn', amountCents: 100, feeCents: 15, netCents: 115, raw: {} } })
